On Error Resume Next
  ...
  strFileText  =  "<html>" &_
				  ...
				  "<br></br>" &_
			  	  "<p>The Monthly Defect report is attached file. If you have any question, please contact PC System Team.</p>" &_
  ...
  strAttachFile0  = path & "\bin\Defect_Monthly_Report_Lastmont_" & Left(MonthName(Month(Date)-1),3) & Right(Year(Date),2) & ".xlsx"
  ...
  With mailobj    
    .To     =  "thmanagers@tbkk.co.th ;jpmanagers@tbkk.co.th"'Send_Bc'"rachit@tbkk.co.th"'Send_Bc'
	.BCC 	=  Send_Bc
    .Subject = TodayA & " : Monthly Defect Report"    
