...
filename = "EXPORT"
namefile = "Defect_Monthly_Report_Lastmont_" & Left(MonthName(Month(Date)-1),3)& Right(Year(Date),2) &".xlsx"
...
xHttp.Open "GET", "http://192.168.161.102/excel_gen/report_defect/ng_monthly/-1/gc_monthly" & Day(Date) & ".xlsx", False
xHttp.Send
