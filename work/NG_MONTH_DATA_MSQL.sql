...
, (SUM(NX.CD_300) + SUM(NX.CD_301) + SUM(NX.CD_302) + SUM(NX.CD_303) + SUM(NX.CD_304) + SUM(NX.CD_305) + SUM(NX.CD_306) + SUM(NX.CD_307) + SUM(NX.CD_308) + SUM(NX.CD_309) + SUM(NX.CD_310) + 
   SUM(NX.CD_311) + SUM(NX.CD_312) + SUM(NX.CD_313) + SUM(NX.CD_314) + SUM(NX.CD_315) + SUM(NX.CD_316) + SUM(NX.CD_317) + SUM(NX.CD_318) + SUM(NX.CD_319)) PD4
, (SUM(NX.CD_402) + SUM(NX.CD_403) + SUM(NX.CD_408) + SUM(NX.CD_412) + SUM(NX.CD_413) + SUM(NX.CD_414)) PE
, (SUM(NX.CD_401) + SUM(NX.CD_404) + SUM(NX.CD_405) + SUM(NX.CD_406) + SUM(NX.CD_407) + SUM(NX.CD_409) + SUM(NX.CD_410) + SUM(NX.CD_411) + SUM(NX.CD_500) + SUM(NX.CD_501) + SUM(NX.CD_415) + SUM(NX.CD_416)) OTH
