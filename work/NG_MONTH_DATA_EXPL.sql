...
FROM
 (
		...
		--AND DF.VEND_CD IS NULL
 		AND DF.RSLT_DATE >= TO_CHAR(TRUNC(ADD_MONTHS(SYSDATE,-1),'MM'),'YYYY/MM/DD') AND DF.RSLT_DATE <= TO_CHAR(LAST_DAY(ADD_MONTHS(SYSDATE,-1)),'YYYY/MM/DD')
		GROUP BY
			DF.VEND_CD
		,	DF.WS_CD
		, DF.ITEM_CD
		...
		FROM
		   T_OPR_RSLT TR
		WHERE
	          TO_CHAR(TR.OPR_DATE,'YYYY/MM/DD') >= TO_CHAR(TRUNC(ADD_MONTHS(SYSDATE,-1),'MM'),'YYYY/MM/DD') AND TO_CHAR(TR.OPR_DATE,'YYYY/MM/DD') <= TO_CHAR(LAST_DAY(ADD_MONTHS(SYSDATE,-1)),'YYYY/MM/DD')
		AND TR.ACPT_QTY > 0
		GROUP BY
			TR.WS_CD
		, TR.ITEM_CD	
		...
		--TO_CHAR(ACPT_DATE,'YYYY/MM/DD') = TO_CHAR(SYSDATE-1,'YYYY/MM/DD')
		  TO_CHAR(ACPT_DATE,'YYYY/MM/DD') >= TO_CHAR(TRUNC(ADD_MONTHS(SYSDATE,-1),'MM'),'YYYY/MM/DD') AND TO_CHAR(ACPT_DATE,'YYYY/MM/DD') <= TO_CHAR(LAST_DAY(ADD_MONTHS(SYSDATE,-1)),'YYYY/MM/DD')
		GROUP BY
		  VEND_CD
		, ITEM_CD
		, PLANT_CD
